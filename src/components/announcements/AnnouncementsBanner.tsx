...
export function AnnouncementsBanner() {
  ...
  return (
    <Card className="mb-6 overflow-hidden border-0 shadow-xl rounded-xl" style={{ background: 'linear-gradient(135deg, hsl(var(--primary) / 0.08), hsl(var(--card)), hsl(var(--accent) / 0.06))' }}>
