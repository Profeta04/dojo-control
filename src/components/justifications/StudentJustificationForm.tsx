...
export function StudentJustificationForm() {
  ...
  // Fetch absences within last 7 days without justification
  const { data: absences, isLoading: loadingAbsences } = useQuery({
    ...
    queryFn: async () => {
      ...
      // Filter out already justified ones
  ...
  // Fetch existing justifications
  const { data: myJustifications, isLoading: loadingJustifications } = useQuery({
                          ...
                          <div className="space-y-4 pt-2">
                            ...
                            <div className="space-y-2">
                              ...
                              <p className="text-[10px] text-muted-foreground">
                                Atestado médico, declaração, etc.
                              </p>
                            </div>
